...
| `__int64`, `double`...                        | `Number`      | `System.Int64`, `System.Double`...                        | `RemoteCall::NumberType`               |
| `std::string`                                 | `String`      | `System.String`                                           | `std::string`                          |
| `std::vector<Type>`                           | `Array`       | `System.Collections.Generic.List<T>`                      | `std::vector<Type>`                    |
| `std::unordered_map<std::string,Type>`        | `Object`      | `System.Collections.Generic.Dictionary<System.String, T>` | `std::unordered_map<std::string,Type>` |
