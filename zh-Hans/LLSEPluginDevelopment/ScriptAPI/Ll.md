...
| `std::vector<Type>`                           | `Array`       | `System.Collections.Generic.List<Type>`              | `std::vector<Type>`                    |
| `std::unordered_map<std::string,Type>`        | `Object`      | `System.Collections.Generic.Dictionary<String,Type>` | `std::unordered_map<std::string,Type>` |
