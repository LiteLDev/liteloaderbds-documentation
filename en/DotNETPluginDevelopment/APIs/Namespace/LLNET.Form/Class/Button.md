...
继承 [Object](https://docs.microsoft.com/zh-cn/DotNET/api/system.object?view=net-6.0) → [SimpleFormElement] → [Button](zh_CN/NET/APIs/Namespace/LiteLoader.Form/Class/Button.md)
